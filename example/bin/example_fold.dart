...
///
/// Handling the result:
/// - Use `.fold` to handle both failure and success cases in a concise functional style.
...
void main() {
  ...
  // Handle result using `.fold` for concise branching logic
  result.fold(
    (error) => log("Failure: $error"),
    (value) => log("Success! Result is $value"),
  );
}
